...
module.exports.register = async function (req, res) {
  ...
  try {
    ...
    if (results.length !== 0) {
      ...
      var sql_query = 'INSERT INTO user(user_name,user_phone,user_email,user_password,adhar_number,state,ip_address) values(?,?,?,?,?,?,?)'
      var values = [req.body.user_name, req.body.user_phone, req.body.user_email, hash,req.body.adhar_number,req.body.state,ip]
      //console.log(values)
